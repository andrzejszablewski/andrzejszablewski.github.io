((e, t) => {
  ...
  function Be(p, h, m, g, v, e) {
    return (
      ...
      l(function (e, t, n, r) {
        ...
        if ((m ? m(d, (s = v || (e ? p : u || g) ? [] : t), n, r) : (s = d), g))
        ...
        if (e) {
          if (v || p) {
            ...
            for (o = s.length; o--; )
              (a = s[o]) &&
                -1 < (i = v ? x.call(e, a) : l[o]) &&
                (e[i] = !(t[i] = a));
          }
        } else (s = Re(s === t ? s.splice(u, s.length) : s)), v ? v(null, t, s, r) : j.apply(t, s);
      })
    );
  }
  function Fe(e, t) {
      ...
      for (n = (t = t || Me(e)).length; n--; )
        ((a = (function e(t) {
          for (
            ...
            if ((n = w.relative[t[l].type])) f = [qe($e(f), n)];
            else {
              if ((n = w.filter[t[l].type].apply(null, t[l].matches))[A]) {
                for (i = ++l; i < o && !w.relative[t[i].type]; i++);
                return Be(
                  1 < l && $e(f),
                  1 < l &&
                    _e(
  ...
  function We(e, t, n, r) {
    ...
    if (((n = n || []), 1 === u.length)) {
      if (
        ...
        if (!(t = (w.find.ID(a.matches[0].replace(f, p), t) || [])[0]))
          return n;
  ...
  k.extend({
    ...
    k.fn.extend({
      data: function (n, e) {
        ...
        if (
          this.length &&
          ((i = c.get(o)), 1 === o.nodeType) &&
          !v.get(o, "hasDataAttrs")
        ) {
          for (t = a.length; t--; )
            a[t] &&
              0 === (r = a[t].name).indexOf("data-") &&
              ((r = D(r.slice(5))), pt(o, r, i[r]));
  ...
  function g(e, t) {
    var n =
      void 0 !== e.getElementsByTagName
        ...
        : [];
    return void 0 === t || (t && b(e, t)) ? k.merge([e], n) : n;
  }
  function Et(e, t) {
    ...
    special: {
      ...
      click: {
        setup: function (e) {
          e = this || e;
          return (
            Tt.test(e.type) && e.click && b(e, "input") && Ot(e, "click", !0),
            !1
          );
        },
        trigger: function (e) {
  ...
  function rn() {
    ...
    O &&
      ...
      vt.appendChild(Zt).appendChild(O),
  ...
  (k.Animation = k.extend(H, {
    ...
    tweener: function (e, t) {
      for (
        var n, r = 0, i = (e = y(e) ? ((t = e), ["*"]) : e.match(I)).length;
        r < i;
        r++
      )
        (n = e[r]),
    ...
    k.fn.extend({
      addClass: function (t) {
        ...
        return y(t)
          ...
          ? this.each(function () {
              if (
                ((r = Ln(this)), (n = 1 === this.nodeType && " " + An(r) + " "))
              ) {
...
$(window).resize(function () {
      ...
      n =
            ...
            open: function (e) {
              ...
              if (!h.isOpen) {
                (h.types = []),
                  ...
                  h.bgOverlay ||
                    ((h.bgOverlay = f("bg").on("click" + T, function () {
                      h.close();
                    })),
                    (h.wrap = f("wrap")
                      .attr("tabindex", -1)
                ...
                d("BeforeOpen"),
                  ...
                  h.fixedContentPos
                    ...
                    : h.wrap.css({ top: j.scrollTop(), position: "absolute" }),
                  (!1 !== h.st.fixedBgPos &&
                  ...
                  h.st.enableEscapeKey &&
                    g.on("keyup" + T, function (e) {
                      27 === e.keyCode && h.close();
                    }),
                  j.on("resize" + T, function () {
                    h.updateSize();
                  }),
                ...
                return (
                  ...
                  setTimeout(function () {
                    h.content
                      ? (h._addClassToMFP(k), h._setFocus())
                      : h.bgOverlay.addClass(k),
                      g.on("focusin" + T, h._onFocusIn);
                  }, 16),
                  (h.isOpen = !0),
                  h.updateSize(a),
                  d(C),
            ...
            updateSize: function (e) {
              ...
              h.isIOS
                ? ((t =
                  ...
                  h.wrap.css("height", (t = window.innerHeight * t)),
                  (h.wH = t))
                : (h.wH = e || j.height()),
        ...
        (c.fn.magnificPopup = function (e) {
          ...
          return (
            "string" == typeof e
              ? "open" === e
                ? ((t = E ? i.data("magnificPopup") : i[0].magnificPopup),
              ...
              : ((e = c.extend(!0, {}, e)),
                E ? i.data("magnificPopup", e) : (i[0].magnificPopup = e),
                h.addGroup(i, e)),
            i
          );
        }),
        ...
        proto: {
          initImage: function () {
            ...
            h.types.push("image"),
              ...
              u(x + t, function () {
                e.cursor && m.removeClass(e.cursor), j.off("resize" + T);
              }),
          ...
          _getOffset: function (e) {
            var e = e
              ...
              e =
                ...
                {
                  width: e.width(),
                  height: (E ? e.innerHeight() : e[0].offsetHeight) - r - n,
                });
            return (
              (I =
                void 0 === I
    ...
    c.magnificPopup.registerModule(H, {
      ...
      (c.fn.destroyMfpFastClick = function () {
        c(this).off("touchstart" + O + " click" + O),
          D && j.off("touchmove" + O + " touchend" + O);
      }),
      o();
  })(window.jQuery || window.Zepto),
  ((e) => {
  ...
  ((e, t) => {
    ...
    function u(e) {
      ...
      r && (e.parent.node.style.position = e.parent.css.position),
        (e.mode = -1);
    }
    function f() {
          ...
          for (var e = A.length - 1; 0 <= e; e--)
            if (A[e].inited) {
              var t = Math.abs(h(A[e].clone) - A[e].docOffsetTop),
                n = Math.abs(
                  A[e].parent.node.offsetHeight - A[e].parent.height
                );
              if (2 <= t || 2 <= n) return;
            }
          return 1;
    ...
    t(),
      ...
      $(".avatar-flip-container").on("click touchstart", function (e) {
        window.matchMedia("(hover: hover) and (pointer: fine)").matches ||
          (e.preventDefault(), $(this).toggleClass("flipped"));
      }),
      $(
